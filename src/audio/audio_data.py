...
class AudioData:
    ...
    def __init__(self, audio_signal: np.ndarray, sample_rate: int):
        ...
        Parameters:
        audio_signal (np.ndarray): The audio signal as a numpy array.
        sample_rate (int): The sample rate of the audio signal in Hertz.
        """
    ...
    @staticmethod
    def to_float(audio_data: np.ndarray) -> np.ndarray:
        """
        ...
        Parameters:
        audio_data (np.ndarray): The audio data to convert to float32.

        Returns:
        np.ndarray: The audio data as a float32 array.
        """
